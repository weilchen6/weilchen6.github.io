...
// Toggle between light and dark. There is no "follow the system" state: the
// page opens light, and the visitor either keeps it or switches.
...
// Determine the expected state of the theme toggle, either "dark" or "light".
// Anything else, including the "system" value older visits may have stored,
// falls back to light.
